...
//!
//! `Litelease` delegates all lease operations to `LiteleaseRef`, so the
...
// -----------------------------------------------------------------------
// Wrapper surface: Litelease-owned bootstrap — file-persistent pragmas only
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Wrapper surface: LiteleaseRef (borrowed path) — all five pragmas
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Wrapper surface: Litelease-owned Transaction / Savepoint
