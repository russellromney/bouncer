...
use litelease::{Bouncer, BouncerRef, ClaimResult, ReleaseResult, RenewResult};
use bouncer_core::attach_bouncer_functions;
...
fn public_stress_repeated_caller_owned_transaction_atomic_visibility() {
    for iteration in 0..32 {
        ...
        let observer_borrowed = BouncerRef::new(&observer);
        ...
        let observer_borrowed = BouncerRef::new(&observer_after);
